...
{
    public class AgroPonienteAdra : SubastasControl
    {
        ...
        {
            return await AgroPrecios.ExtraerInformacion(GetSubasta(ValoresConstantes.subastasENUM.agroponiente_adra, listSubasta));
        }
    }
}
