...
namespace camionet
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Configurar MySQL
            builder.Services.AddDbContext<ApiSubastasDbContext>(options =>
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Subastas API", Version = "v1.0" });
            ...
            builder.Services.AddScoped<ExtraccionDatosController>();
            builder.Services.AddScoped<FamiliaController>();
            builder.Services.AddScoped<GeneroController>();
            builder.Services.AddScoped<SubastaController>();
            builder.Services.AddScoped<SubastaDetalleController>();
